			...
			<div id="primary" class="col-xs-12">
				<div id="content" role="main">
					...
					<div class="content_intro_category">
						<?php if( get_field('taxonomia_img') ): ?>
							<figure>
										<img src=" <?php the_field('taxonomia_img'); ?> " alt="">
							</figure>
						<?php endif; ?>
								...
								<div class="post-list-item">
									<div class="list-image">
										<a href="<?php the_permalink() ?>">
											<img src="<?php the_field('img_tumb-tratamentos')?>" alt="">
										</a>
									</div>
									<div class="list-text">
										<a href="<?php the_permalink() ?>">
											<div class="content_description">
												<h2><?php the_title()?></h2>
												<div class="description-content_category"><?php the_content()?></div>
												<a class="cta" href="<?php the_permalink() ?>">VER MAIS</a>
											</div>
										</a>
									</div>
								</div>
